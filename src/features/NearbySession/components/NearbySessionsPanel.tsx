...
import RadarScanView from "./RadarScanView";
import NearbyListeningControl from "./NearbyListeningControl";
...
type NearbySessionsPanelProps = {
  bottomPadding: number;
};

export default function NearbySessionsPanel({
  bottomPadding,
}: NearbySessionsPanelProps) {
    ...
    <>
      ...
      >
        <MyText
          ...
          textAlign="center"
        >
          Discover people playing music around you and join their session in
          sync.
        </MyText>
